...
const ContactSelector = ({ isOpen, onClose, onSelectContacts }) => {
            ...
            <div className="card" style={{
                            ...
                            {filteredContacts.map(contact => (
                                <label
                                    ...
                                    style={{
                                        ...
                                        background: selectedIds.has(contact.id) ? 'var(--bg-secondary)' : 'transparent',
                                        border: `2px solid ${selectedIds.has(contact.id) ? 'var(--primary)' : 'var(--border)'}`,
                                        cursor: 'pointer',
                                        transition: 'all 0.2s'
                                    }}
                                >
                ...
                <div style={{ padding: '1rem 1.5rem', borderTop: '1px solid var(--border)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    ...
                    <div style={{ display: 'flex', gap: '0.75rem' }}>
                        ...
                        >
                            <Check size={16} /> Add {selectedIds.size > 0 && `(${selectedIds.size})`}
                        </button>
                    </div>
                </div>
            </div>
