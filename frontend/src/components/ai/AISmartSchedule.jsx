...
const AISmartSchedule = ({ event, onScheduleGenerated }) => {
    ...
    const handleGenerate = async () => {
        if (!prompt.trim()) {
            setError('Please describe your event schedule first.');
            return;
        }
        ...
        try {
            ...
            const res = await fetch(`${API_URL}/events/${event.id}/schedule/generate`, {
                method: 'POST',
                headers: {
            ...
            if (!res.ok) {
                ...
                if (res.status === 403 && errorData.error?.includes('Pro subscription required')) {
                    setUpgradeReason(errorData.message || 'Upgrade to Pro to auto-generate schedules');
    ...
    return (
        ...
        <div style={{
            ...
            <p style={{ fontSize: '14px', color: 'var(--text-secondary)', marginBottom: '16px', lineHeight: '1.5' }}>
                Don't want to add items manually? Tell the AI what kind of event you're hosting and it will auto-draft a complete itinerary for you.
            </p>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                <textarea
                    ...
                    placeholder="e.g. 'Draft a 3-hour superhero birthday party timeline starting at 2 PM'"
