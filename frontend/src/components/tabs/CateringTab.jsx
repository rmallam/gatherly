...
const CateringTab = ({ event, onUpdateCatering }) => {
    ...
    const { API_URL } = useApp(); // Ensure API_URL is available if needed, though mostly using user here
            ...
            {(!user?.subscription_tier || user?.subscription_tier === 'free') && (
                <div style={{
                    ...
                    <p style={{
                        ...
                        Unlock AI-powered menu recommendations tailored to your event theme and preferences.
                    </p>
                    <a
                        href="/pro"
                        style={{
