                            ...
                            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '1rem', flexWrap: 'wrap' }}>
                                ...
                                <div style={{ flex: 1, minWidth: 0 }}>
                                    ...
                                    <div style={{ fontSize: '0.875rem', color: 'var(--text-secondary)', display: 'flex', alignItems: 'center', gap: '0.75rem', flexWrap: 'wrap' }}>
                                        {guest.phone ? (
                                            <a href={`tel:${guest.phone}`} style={{ color: 'var(--primary)', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '0.25rem', whiteSpace: 'nowrap' }}>
                                                <Smartphone size={14} /> {guest.phone}
                                            </a>
                                        ) : (
                                            <span>No phone</span>
                                        )}
                                ...
                                <div style={{ display: 'flex', gap: '0.5rem', flexShrink: 0 }}>
                                    ...
                                    <button
                                        ...
                                        title={sharedGuestId === guest.id ? "Shared!" : "Share invitation"}
                                    >
                                        {sharedGuestId === guest.id ? <CheckCircle2 size={18} /> : <Share2 size={18} />}
                                    </button>
                                    {/* QR Code Button */}
                                    <button
                                    ...
                                    <button
                                        ...
                                        style={{ width: '36px', height: '36px', padding: '0', display: 'flex', alignItems: 'center', justifyContent: 'center', borderRadius: 'var(--radius-md)', background: '#ef4444', color: 'white', border: 'none' }}
                                        title="Delete guest"
                                    >
                                        <Trash2 size={18} />
                                    </button>
